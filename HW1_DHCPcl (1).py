...
class DHCP_client(object):
	...
	def client(this_object):
		...
		data = this_object.dhcpdiscover_get()
		#data = dhcpdiscover_get()
		...
		data = this_object.dhcprequest_get()
		sock.sendto(data, dest)
		print("\nwaiting DHCPACK")
